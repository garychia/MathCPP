...
TEST(Vector, FillConstructor) {
  ...
  for (int i = 0; i < sizeof(VECTOR_LENGHTS) / sizeof(VECTOR_LENGHTS[ZERO]);
       i++) {
...
TEST(Vector, InitializerListConstructor) {
  ...
  const auto FLOAT_VECTOR_CONTENT = {-2.124f, 23.2f - 82.32f, 2343.3f, 1.04f,
                                     0.f,     321.3f,         -9.f};
  const auto DOUBLE_VECTOR_CONTENT = {3.14, -1.234, -0.234, -94.3,
                                      0.0,  23.0,   -7.5,   0.85};
...
TEST(Vector, ArrayConstructor) {
  ...
  const std::array<float, 8> FLOAT_VECTOR_CONTENT = {
      -2.124f, 23.2f - 82.32f, 2343.3f, 1.04f, 0.f, 321.3f, -9.f};
  const std::array<double, 10> DOUBLE_VECTOR_CONTENT = {
      3.14, -1.234, -0.234, -94.3, 0.0, 23.0, -7.5, 0.85, 1.23, 3224.3423};
  Vector<int> initVectorInt(INT_VECTOR_CONTENT);
  Vector<float> initVectorFloat(FLOAT_VECTOR_CONTENT);
  Vector<double> initVectorDouble(DOUBLE_VECTOR_CONTENT);
  EXPECT_EQ(initVectorInt.Size(), INT_VECTOR_CONTENT.size());
...
TEST(Vector, StdVectorConstructor) {
  ...
  const std::vector<float> FLOAT_VECTOR_CONTENT(
      {-2.124f, 23.2f, -82.32f, 84.3f, 1.04f, 0.f, 32.3f, -9.f, 23.f});
  const std::vector<double> DOUBLE_VECTOR_CONTENT(
      {3.14, -1.24, -0.5576, -94.3, 0.0, 23.0, -7.5, 0.85, 1.23, 2.3423});
  Vector<int> initVectorInt(INT_VECTOR_CONTENT);
  Vector<float> initVectorFloat(FLOAT_VECTOR_CONTENT);
  Vector<double> initVectorDouble(DOUBLE_VECTOR_CONTENT);
  EXPECT_EQ(initVectorInt.Size(), INT_VECTOR_CONTENT.size());
...
TEST(Vector, MoveConstructor) {
  const std::vector<int> INT_VECTOR_CONTENT(
      {43, -13, 90, -39, 0, 23, -75, 23, 35, -93, 75, 46});
  const std::vector<float> FLOAT_VECTOR_CONTENT(
      {-2.124f, 23.2f, -82.32f, 84.3f, 1.04f, 0.f, 32.3f, -9.f, 23.f});
  const std::vector<double> DOUBLE_VECTOR_CONTENT({3.14, -1.24, -0.5576, -94.3,
                                                   0.0, -3.1343, 23.0, -7.5,
                                                   0.85, 1.23, 2.3423});
  Vector<int> initVectorInt(INT_VECTOR_CONTENT);
  Vector<float> initVectorFloat(FLOAT_VECTOR_CONTENT);
...
TEST(Vector, Length) {
  ...
  Vector<int> t0;
  EXPECT_THROW(
      try { t0.Length<float>(); } catch (const Exceptions::EmptyVector &e) {
        std::stringstream ss;
...
template <class T> void CheckVectorLpNorm(const Vector<T> &v, int p) {
  if (v.Size() == 0) {
    EXPECT_THROW(
        try {
...
TEST(Vector, LpNorm) {
  ...
  Vector<double> v3(
      {23.345, 4.43, 5.345, 64.23, 32.56, 6.4537, 32.536, 54.4535, 2684.567});
...
void CheckVectorAddition(const Vector<T> &v1, const Vector<U> &v2) {
  if (v1.Size() == 0) {
    EXPECT_THROW(
        try { v1.Add(v2); } catch (const Exceptions::EmptyVector &e) {
          std::stringstream ss;
    ...
    EXPECT_THROW(
        try { v1.Add(v2); } catch (const Exceptions::InvalidArgument &e) {
          std::stringstream ss;
    ...
    EXPECT_THROW(
        try { v1.Add(v2); } catch (const Exceptions::InvalidArgument &e) {
          std::stringstream ss;
          ss << "Vector: Expected the dimension of the second operand to be a "
                "factor of that of the first operand.";
          EXPECT_TRUE(e.what() == ss.str());
          throw e;
        },
        Exceptions::InvalidArgument);
...
void CheckScalerAddition(const Vector<T> &v1, const Scaler &s) {
  if (v1.Size() == 0) {
    EXPECT_THROW(
        try { v1.Add(s); } catch (const Exceptions::EmptyVector &e) {
          std::stringstream ss;
          ss << "Vector: Cannot perform addition on an empty vector.";
          EXPECT_TRUE(e.what() == ss.str());
          throw e;
...
void CheckOperatorPlusVector(const Vector<T> &v1, const Vector<U> &v2) {
  if (v1.Size() == 0) {
    EXPECT_THROW(
        try { v1 + v2; } catch (const Exceptions::EmptyVector &e) {
          std::stringstream ss;
          ss << "Vector: Cannot perform addition on an empty vector.";
          EXPECT_TRUE(e.what() == ss.str());
          throw e;
    ...
    EXPECT_THROW(
        try { v1 + v2; } catch (const Exceptions::InvalidArgument &e) {
          std::stringstream ss;
          ss << "Vector: Cannot perform addtion on the given empty vector.";
          EXPECT_TRUE(e.what() == ss.str());
          throw e;
...
void CheckOperatorPlusScaler(const Vector<T> &v1, const Scaler &s) {
  if (v1.Size() == 0) {
    EXPECT_THROW(
        try { v1 + s; } catch (const Exceptions::EmptyVector &e) {
          std::stringstream ss;
          ss << "Vector: Cannot perform addition on an empty vector.";
          EXPECT_TRUE(e.what() == ss.str());
          throw e;
...
void CheckVectorSubtraction(const Vector<T> &v1, const Vector<U> &v2) {
  if (v1.Size() == 0) {
    EXPECT_THROW(
        try { v1.Minus(v2); } catch (const Exceptions::EmptyVector &e) {
          std::stringstream ss;
    ...
    EXPECT_THROW(
        try { v1.Minus(v2); } catch (const Exceptions::InvalidArgument &e) {
          std::stringstream ss;
...
TEST(Vector, Minus) {
  ...
  Vector<float> v3(
      {-2.124f, 23.2f, -82.32f, 84.3f, 1.04f, 0.f, 32.3f, -49.f, 23.43f});
  Vector<double> v4(
      {3.14, -1.24, -0.5576, -94.3, 0.0, 23.0, -7.5, 64.56, 1.23, 2.3423});
  Vector<int> v0;
...
void CheckScalerSubtraction(const Vector<T> &v1, const Scaler &s) {
  if (v1.Size() == 0) {
    EXPECT_THROW(
        try { v1.Minus(s); } catch (const Exceptions::EmptyVector &e) {
          std::stringstream ss;
          ss << "Vector: Cannot perform subtraction on an empty vector.";
          EXPECT_TRUE(e.what() == ss.str());
          throw e;
...
TEST(Vector, MinusScaler) {
  ...
  Vector<float> v3(
      {-2.1454f, 243.2f, -582.32f, 874.3f, 165.04f, 10.f, 332.3f, 0.f, 23.f});
  Vector<double> v4({23.435, -1.24454, -0.55676, -964.3, 0.0, 23.0, -7.45455,
                     0.4485, 1.2323, 2.3423});
  Vector<int> v0;
  const int s1 = 322342;
...
TEST(Vector, OperatorMinusScaler) {
  ...
  Vector<float> v3({-5636.1454f, 243.2f, -582.32f, 874.3f, 23.234f, 1540.f,
                    332.3f, 6800450.f, 23.34532f});
  Vector<double> v4({23.435, -1.24454, -923.55676, -964.3, 0.0, 23.0324,
                     -7.45455, 0.4485, 1.2323, 2.3423});
  Vector<int> v0;
  const int s1 = 322342;
...
void CheckScaleScaler(const Vector<T> &v1, const Scaler &s) {
  if (v1.Size() == 0) {
    EXPECT_THROW(
        try { v1.Scale(s); } catch (const Exceptions::EmptyVector &e) {
          std::stringstream ss;
...
void CheckScaleVector(const Vector<T> &v1, const Vector<U> &v2) {
  if (v1.Dimension() == 0) {
    EXPECT_THROW(
        try { v1.Scale(v2); } catch (const Exceptions::EmptyVector &e) {
          std::stringstream ss;
          ss << "Vector: Cannot perform scaling on an empty vector.";
          EXPECT_TRUE(e.what() == ss.str());
          throw e;
    ...
    EXPECT_THROW(
        try { v1.Scale(v2); } catch (const Exceptions::InvalidArgument &e) {
          std::stringstream ss;
          ss << "Vector: Cannot perform scaling with an empty vector as the "
                "second operand.";
          EXPECT_TRUE(e.what() == ss.str());
          throw e;
        },
...
void CheckOperatorMultiplyVector(const Vector<T> &v1, const Vector<U> &v2) {
  if (v1.Dimension() == 0) {
    EXPECT_THROW(
        try { v1 *v2; } catch (const Exceptions::EmptyVector &e) {
          std::stringstream ss;
          ss << "Vector: Cannot perform element-wise multiplication on an "
                "empty vector.";
          EXPECT_TRUE(e.what() == ss.str());
          throw e;
        },
    ...
    EXPECT_THROW(
        try { v1 *v2; } catch (const Exceptions::InvalidArgument &e) {
          std::stringstream ss;
          ss << "Vector: Cannot perform element-wise multiplication with an "
    ...
    EXPECT_THROW(
        try { v1 *v2; } catch (const Exceptions::InvalidArgument &e) {
          std::stringstream ss;
          ss << "Vector: Expect the dimension of the second operand is a "
                "factor of that "
                "of the first operand when performing element-wise "
                "multiplication.";
          EXPECT_TRUE(e.what() == ss.str());
          throw e;
        },
...
TEST(Vector, OperatorMultiplyAssignmentScaler) {
  ...
  Vector<float> v3({-103.1454f, 13.2f, -75.32f, 74.3f, -23.234f, 67.f, 53.3f,
                    434.f, 23.565});
  Vector<double> v4({23.435, -1.24454, -421.55676, -403.3, 324.0, 23.0324,
                     -7.45455, 0.4485, 71.756, 42.3423});
  Vector<int> v0;
  const int s1 = -234;
...
void CheckDivideScaler(const Vector<T> &v1, const Scaler &s) {
  if (v1.Size() == 0) {
    EXPECT_THROW(
        try { v1.Divide(s); } catch (const Exceptions::EmptyVector &e) {
          std::stringstream ss;
    ...
    EXPECT_THROW(
        try { v1.Divide(s); } catch (const Exceptions::DividedByZero &e) {
          std::stringstream ss;
          ss << "Division by zero occurred.\n";
          ss << "Vector: Cannot perform element-wise division as the second "
                "operand is 0.";
          EXPECT_TRUE(e.what() == ss.str());
          throw e;
        },
...
void CheckDivideVector(const Vector<T> &v1, const Vector<U> &v2) {
  if (v1.Dimension() == 0) {
    EXPECT_THROW(
        try { v1.Divide(v2); } catch (const Exceptions::EmptyVector &e) {
          std::stringstream ss;
          ss << "Vector: Cannot perform element-wise division on an empty "
                "vector.";
          EXPECT_TRUE(e.what() == ss.str());
    ...
    EXPECT_THROW(
        try { v1.Divide(v2); } catch (const Exceptions::InvalidArgument &e) {
          std::stringstream ss;
          ss << "Vector: Cannot perform element-wise division as the second "
                "operand is empty.";
          EXPECT_TRUE(e.what() == ss.str());
    ...
    EXPECT_THROW(
        try { v1.Divide(v2); } catch (const Exceptions::InvalidArgument &e) {
          std::stringstream ss;
          ss << "Vector: Cannot perform element-wise division. Expected the "
                "dimension of the "
  ...
  if (!hasZero) {
    ...
    EXPECT_THROW(
        try { v1.Divide(v2); } catch (const Exceptions::DividedByZero &e) {
          std::stringstream ss;
          ss << "Division by zero occurred.\n";
          ss << "Vector: Expect none of the element of the second operand to "
                "be 0 when performing"
...
TEST(Vector, DivideVector) {
  ...
  Vector<int> v2({269, -34, 43, 283, 364, -323, 734, 849});
  Vector<float> v3(
      {-2.124f, 23.2f, -82.32f, 84.3f, 1.04f, 0.3f, 32.3f, -49.f, 23.43f});
  Vector<double> v4(
      {3.14, -1.24, -0.5576, -94.3, 0.1, 23.0, -7.5, 64.56, 1.23, 2.3423});
  Vector<float> badV1(
      {-2.124f, 23.2f, -4.32f, 0.f, 1.04f, 0.f, 32.3f, -49.f, 23.43f});
  Vector<double> badV2(
      {3.14, -1.24, -0.5576, -2.3, 0.0, 23.0, -7.5, 64.56, 1.23, 2.0});
  Vector<int> v0;
...
void CheckOperatorDivideScaler(const Vector<T> &v1, const Scaler &s) {
  if (v1.Size() == 0) {
    ...
    EXPECT_THROW(
        try { v1 / s; } catch (const Exceptions::DividedByZero &e) {
          std::stringstream ss;
          ss << "Division by zero occurred.\n";
          ss << "Vector: Cannot perform element-wise division as the second "
                "operand is 0.";
...
void CheckOperatorDivideVector(const Vector<T> &v1, const Vector<U> &v2) {
  ...
  if (!hasZero) {
    ...
    EXPECT_THROW(
        try { v1 / v2; } catch (const Exceptions::DividedByZero &e) {
          std::stringstream ss;
          ss << "Division by zero occurred.\n";
          ss << "Vector: Expect none of the element of the second operand to "
                "be 0 when performing"
...
void CheckOperatorDivideAssignmentVector(Vector<T> &v1, const Vector<U> &v2) {
  if (v1.Size() == 0) {
    ...
    EXPECT_THROW(
        try { v1 /= v2; } catch (const Exceptions::InvalidArgument &e) {
          std::stringstream ss;
          ss << "Vector: Cannot perform element-wise division when the second "
                "operand is empty.";
          EXPECT_TRUE(e.what() == ss.str());
          throw e;
        },
...
void CheckDotProduct(const Vector<T> &v1, const Vector<U> &v2) {
  if (v1.Dimension() == 0) {
    EXPECT_THROW(
        try { v1.Dot(v2); } catch (const Exceptions::EmptyVector &e) {
          std::stringstream ss;
    ...
    EXPECT_THROW(
        try { v1.Dot(v2); } catch (const Exceptions::InvalidArgument &e) {
          std::stringstream ss;
          ss << "Vector: Cannot perform dot product when the second operand is "
                "empty.";
          EXPECT_TRUE(e.what() == ss.str());
          throw e;
        },
    ...
    EXPECT_THROW(
        try { v1.Dot(v2); } catch (const Exceptions::InvalidArgument &e) {
          std::stringstream ss;
          ss << "Vector: Cannot perform dot product on vectors with different "
                "dimensions.";
          EXPECT_TRUE(e.what() == ss.str());
          throw e;
        },
...
template <class T> void CheckNormalized(const Vector<T> &v) {
  if (v.Dimension() == 0) {
    EXPECT_THROW(
        try {
...
template <class T> void CheckNormalize(Vector<T> &v) {
  if (v.Dimension() == 0) {
    EXPECT_THROW(
        try { v.Normalize(); } catch (const Exceptions::EmptyVector &e) {
          std::stringstream ss;
          ss << "Vector: Cannot perform normalization on an empty vector.";
          EXPECT_TRUE(e.what() == ss.str());
          throw e;
  ...
  if (len == 0) {
    EXPECT_THROW(
        try { v.Normalize(); } catch (const Exceptions::DividedByZero &e) {
          std::stringstream ss;
          ss << "Division by zero occurred.\n";
          ss << "Vector: Cannot normalize a zero vector.";
          EXPECT_TRUE(e.what() == ss.str());
...
TEST(Vector, Normalize) {
  ...
  Vector<double> v2(
      {269.4, -34.64, 43.032, 283.34032, 364.0, -43.0, 4.023, 9.0});
  Vector<float> v3(
      {-2.124f, 23.2f, -82.32f, 84.3f, 1.04f, 0.3f, 32.3f, -49.f, 23.43f});
  Vector<double> v4(
      {3.14, -1.24, -0.5576, -94.3, 0.1, 23.0, -7.5, 64.56, 1.23, 2.3423});
...
template <class T> void CheckSum(const Vector<T> &v) {
  T sum = 0;
  for (std::size_t i = 0; i < v.Size(); i++)
    sum += v[i];
...
template <class T, class Func> void CheckMap(const Vector<T> &v, Func &&f) {
...
TEST(Vector, Map) {
  ...
  Vector<float> v2(
      {-2.124f, 23.2f, -82.32f, 84.3f, 1.04f, 0.3f, 32.3f, -49.f, 23.43f});
  Vector<double> v3(
      {3.14, -2.0, 32.32, 8.235, 23.0, -7.5, 64.56, 1.23, 2.3423});
...
template <class T> void CheckAsRawPointer(const Vector<T> &v) {
...
void CheckScalerVectorDivision(const Scaler &s, const Vector<T> &v) {
  ...
  if (hasZero) {
    EXPECT_THROW(
        try { s / v; } catch (const Exceptions::DividedByZero &e) {
          std::stringstream ss;
          ss << "Division by zero occurred.\nVector: Expect none of the "
                "elements of the second operand to be 0 when performing "
                "element-wise division.";
          EXPECT_TRUE(e.what() == ss.str());
          throw e;
        },
