...
#define ARRAY_ARITHMETIC_FUNCTION(func_name, op)                               \
  ...
  __global__ void func_name(                                                   \
      OutputType *dest, const FirstOperandType *operand1,                      \
...
#define ARRAY_SCALER_FUNCTION(func_name, op)                                   \
  template <class OutputType, class ArrayType, class ScalerType,               \
            class IndexType>                                                   \
  __global__ void func_name(OutputType *dest, const ArrayType *arr,            \
